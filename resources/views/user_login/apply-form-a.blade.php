...
<section class="tabs-section apply-card">
    <div class="container">
        <div class="apply-card-header" style="background-color: #70c6ef  !important;">
            <div class="row">
                ...
                <div class="col-6 col-lg-4 text-md-right">
                    <a href="{{url('assets/pdf/form_a_notes.pdf')}}" class="text-dark" target="_blank">
                        <span style="color: #000;"> <i class="fa fa-file-pdf-o" style="color: red;"></i>&nbsp; Enclosures Download </span>
                        <br>
                        English</a>
        ...
        <form id="competency_form_a" enctype="multipart/form-data">
            ...
            <input type="hidden" class="form-control text-box single-line" id="form_name" name="form_name" value="EA">


            <input type="hidden" class="form-control text-box single-line" id="license_name" name="license_name" value="A">
            ...
            <div class="tabs" id="tabbedForm">
                ...
                <div class="tab" data-name="Basic Details">
                    ...
                    <div class="border box-shadow-blue p-3 mt-3 proprietor-entry">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <h5>Proprietor/Partner Details Draft {{ $index + 1 }}</h5>
                            </div>
                            @if($index > 0)
                            ...
                            <div class="col-md-6">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control mb-2" maxlength="50" id="proprietor_name" name="proprietor_name[]" placeholder="Name" value="{{ $proprietor->proprietor_name }}" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')">
              ...
              <input type="hidden" name="proprietor_id[]" value="{{ $proprietor->id }}">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    @php
                                        $isVerified = $proprietor->proprietor_cc_verify ?? null;
                                    @endphp
                                    <div class="col-12 col-md-5 mt-1 competency-fields-{{ $index }}" style="{{ $showCompetencyFields ? '' : 'display: none;' }}">
                                       ...
                                       @if($isVerified === '1')
                                            <span class="text-success text-center">
                                                <i class="fa fa-check"></i> Valid License
                                            </span>
                                        @elseif($isVerified === '0')
                                            <span class="text-danger text-center">
                                                <i class="fa fa-close"></i> Invalid License
                                            </span>
                                        @endif
                                    </div>
                                    ...
                                    placeholder="Validity"
                                    onfocus="(this.type='date')"
                                    value="{{ isset($proprietor->competency_certificate_validity) ? \Carbon\Carbon::parse($proprietor->competency_certificate_validity)->format('Y-m-d') : '' }}"
                                    {{ $isVerified ? 'readonly' : '' }}>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mt-2 experience-fields-{{ $index }}" style="{{ $showpreviousexpdetails ? '' : 'display: none;' }}">
                                    ...
                                    <div class=" row">
                                        ...
                                        $isVerified_contractor_license = $proprietor->proprietor_contractor_verify ?? null;
                                        @endphp
                                        ...
                                        value="{{ $proprietor->previous_experience_lnumber_validity ? \Carbon\Carbon::parse($proprietor->previous_experience_lnumber_validity)->format('Y-m-d') : '' }}"
                                        onfocus="(this.type='date')"
                                        placeholder="License Number Validity"
                                        {{ $isVerified_contractor_license ? 'readonly' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <!-- <textarea rows="3" class="form-control" name="proprietor_name"></textarea> -->
                                        <label>Proprietor Name <span class="text-red">*</span></label>
                                        <input type="text" class="form-control mb-2 proprietor_name" maxlength="50" id="proprietor_name" name="proprietor_name[]" placeholder="Name">
                            ...
                            <table class="table table-bordered" id="staff-table">
                                ...
                                <tbody id="staff-container">
                                    ...
                                    @for ($i = 0; $i < $staff_count; $i++)
                                        ...
                                        <td>
                                            <input type="text" class="form-control cc_validity" name="cc_validity[]" placeholder="Validity" max="{{ date('d-m-Y') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-12">
                                        <input type="number" class="form-control" id="bank_amount"   max="99999"
                                            oninput="if(this.value.length > 5) this.value = this.value.slice(0, 5);" name="bank_amount" value="{{ $application->bank_amount ?? '' }}">
                            ...
                            <div class="col-md-12">
                                <div class="row align-items-center border-right-12">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <div class="row authority-name-row">
