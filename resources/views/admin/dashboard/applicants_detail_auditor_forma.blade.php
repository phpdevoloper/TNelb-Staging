                ...
                <div id="tabsSimple" class="col-xl-6 col-6 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="modal-footer mt-2" style="justify-content: center">
                            <button class="btn btn-success " id="confirmForward" style="margin-right: 20px;">Forward To Secretary</button>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="mt-container mx-auto">
                                <div class="timeline-line">
                                    ...
                                    <div class="item-timeline">
                                        <p class="t-time">{{ format_date_other($row->updated_at) }}</p>
                                    ...
                                    <div class="item-timeline">
                                        ...
                                        <p class="t-time">{{ format_date_other($user_entry->updated_at) }}</p>
...
<script>
    ...
    forwardButton.click(function (e) {
        ...
        let queryType       = @json($queries);

        // 🔹 Show simple confirmation SweetAlert
        Swal.fire({
            title: 'Are you sure?',
            text: "Do you want to forward this application?",
            icon: 'warning',
