                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card-bottom-section">
                                                ...
                                                <div class="layout-top-spacing" style="text-align: end">
                                                    ...
                                                    <a href="{{ route('admin.completed_pres', ['form_id' => $form->id]) }}" class="" data-form="{{ $form->id }}">
                                            ...
                                            <a href="{{ route('admin.view_president', ['form_id' => $form->id]) }}" class="" data-form="{{ $form->id }}">
                                        ...
                                        <div class="col-lg-9 col-9">
                                            <div class="balance-info">
                                                ...
                                                <h5>License EB</h5>
                                                 ...
                                                 <a href="{{ route('admin.view_secratary')  }}" class="">  <h4> Pending <span class="badge badge-warning">15+</span></h4></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-9">
                                            <div class="balance-info">
                                                <h6>Form A</h6>
                                                <h5>License EA</h5>
                                                 <a href="president_completed_forma"><h4> Completed <span class="badge badge-success">{{ $presidentFormA->completed_count }}</span></h4></a>
                                                 <a href="{{ route('admin.president_pending_forma')  }}" class=""> <h4> Pending <span class="badge badge-warning">{{ $presidentFormA->pending_count }}</span></h4></a>
