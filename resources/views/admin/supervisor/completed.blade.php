                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="seperator-header">
                            <h4 class="">Completed Applications For {{ $workflows->first()->form_name ?? 'N/A' }} (License {{ $workflows->first()->license_name ?? 'N/A' }} )</h4>
                        </div>
                                ...
                                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (in_array($application->status, ['F','RF']))
                                                    <span class="badge badge-warning">Forwarded</span>
                                                @elseif (in_array($application->status, ['A']))
                                            ...
                                            <td>
                                                ...
                                                @if ($application->status == 'A')
                                                    <a href="{{ route('admin.generate.pdf', ['application_id' => $application->application_id]) }}" target="_blank"><span class="badge badge-primary">view</span></a>
                                                @else
                                                    {{ '-' }}
                                                @endif
