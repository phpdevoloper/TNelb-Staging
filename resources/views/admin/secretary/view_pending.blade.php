            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="seperator-header layout-top-spacing">
                        <h4 class="">Pending Applications For FORM S (License C )</h4>
                    </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home-icon" role="tabpanel"
                                    ...
                                    <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                        ...
                                        <tbody>
                                            @foreach($new_applications as $key => $workflow)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                ...
                                                {{-- <td>{{ $workflow->form_name }}</td>
                                                <td>{{ $workflow->license_name }}</td> --}}
                                                <td>Success </td>
                                                <td>{{ !empty($workflow->created_at)? format_date_other($workflow->created_at): '' }}</td>
                                                <td>
                                                <a href="{{ route('admin.applicants_detail', ['applicant_id' => $workflow->application_id]) }}">
                                ...
                                <div class="tab-pane fade" id="pills-profile-icon" role="tabpanel"
                                    ...
                                    <table id="" class="zero-config table dt-table-hover" style="width:100%">
                                        ...
                                        <tbody>
                                            @foreach($renewal as $key => $workflow)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
