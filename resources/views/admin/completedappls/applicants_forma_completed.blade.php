                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <p>{{ strtoupper($applicant->previous_contractor_license) }}  </p>
                                    ...
                                    <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                        ...
                                        <div class="row mt-3">
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-lg-6 d-flex align-items-center justify-content-center">
                                                    <div class="form-check">
                                                        <input type="checkbox" id="reset_all" name="reset_all" class="form-check-input" disabled>
...
<script>
 ...
 forwardbtn.click(function() {
            Swal.fire({
                ...
                `,
                showCancelButton: true,
                confirmButtonText: "Forward to {{ $applicant->application_status == 'RE' ? 'Accountant' : '' }}",
                cancelButtonText: "Cancel",
                focusConfirm: false,
            }).then((result) => {
                if (result.isConfirmed) {
