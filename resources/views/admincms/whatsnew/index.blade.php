...
<div id="content" class="main-content">
            ...
            <div class="row layout-top-spacing dashboard">
                <nav class="breadcrumb-style-five breadcrumbs_top  mb-2" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Portal Scroll Message Management Console</li>
                    </ol>
                </nav>
                        ...
                        <div class="widget-header">
                            <div class="row mt-2">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4 class="text-dark card-title">Portal Scroll Message Management Console </h4>
                                </div>
                ...
                <div class="modal fade inputForm-modal reset-on-open" id="inputFormModaladdnews" tabindex="-1" role="dialog" aria-labelledby="inputFormModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                        <div class="modal-content">

                            <div class="modal-header" id="inputFormModalLabel">
                                <h5 class="modal-title">Add New Scroll Message</h5>
                            ...
                            <div class="modal-body">
                                <form class="mt-0" id="whatsnewform">
                                    <!-- Page Type Selection -->
                            ...
                            <div class="widget-header">
                                <div class="card-header">
                                    ...
                                    <div class="float-right">
                                        <button type="button" class="btn btn-info mb-2 me-4 float-end" data-bs-toggle="modal" data-bs-target="#inputFormModaladdnews">
                                            <i class="fa fa-plus"></i>&nbsp; Add New Scroll Message
                                        </button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="style-3" class="table style-3 dt-table-hover portaladmin">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-id="{{ $news->id }}">
                                            ...
                                            <td class="">
                                                {!! nl2br(e(wordwrap($news->subject_en, 20, "\n"))) !!}
                                            </td>
                                            <td class="table_tdcontrol">
                                                {!! nl2br(e(wordwrap($news->subject_ta, 20, "\n"))) !!}
                                            </td>

                                            <td class="table_tdcontrol">{{ \Carbon\Carbon::parse($news->startdate)->format('d-m-Y') }}</td>
                                                ...
                                                <ul class="table-controls">
                                                    <li>
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-pdf_ta="{{ $news->external_url ? asset($news->external_url) : '' }}"
                                                            data-external_url="{{ $news->external_url ? asset($news->external_url) : '' }}"
                                                            class="bs-tooltip editscrollMenucontent" title="Edit">
    ...
    <div class="modal fade inputForm-modal" id="inputFormModaleditboard" tabindex="-1" role="dialog" aria-labelledby="inputFormModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" id="inputFormModalLabel">
                    <h5 class="modal-title">Edit Scroll Message Content</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form class="mt-0" id="scrollboardedit">
                        <input type="hidden" name="id" id="whatsnew_id">
                        <input type="hidden" name="updated_by" value="{{Auth::user()->name}}">
