...
class LoginController extends Controller
{
   ...
   // -----------------form A -------------------
    ...
    public function view_application_details($applicant_id)
    {
        ...
        return view('admin.dashboard.view_application', compact('applicant', 'educationalQualifications', 'workExperience', 'uploadedPhoto',
        'documents', 'nextForwardUser', 'returnForwardUser', 'workflows', 'queries', 'user_entry', 'staff'));
