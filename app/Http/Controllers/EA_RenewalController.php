...
// ------------form A draft and renew-------------
      public function renew_form($appl_id)
    {
        ...
        return view('user_login.renew-form', compact('applicationid', 'application_details', 'edu_details', 'exp_details', 'apps_doc', 'license_details', 'uploadedPhotos', 'applicant_photo'));
    }
     ...
     public function renew_form_ea($application_id){
        ...
        $license_deatails = DB::table('tnelb_license')->where('application_id', $application_id)->first();
        ...
        if ($application_id) {
            ...
            $staffs = DB::table('tnelb_applicant_formA_staffdetails')->where('application_id', $application_id)->orderBy('id', 'ASC')->get();
        ...
        return view('user_login.renew-form_ea', compact ('application', 'proprietors', 'staffs', 'draftCount', 'document','license_details'));
    }
    ...
    public function edit($application_id)
    {
        ...
        return view('user_login.apply-form-a', compact('application', 'proprietors', 'draftCount', 'staffs', 'document'));
    }
      ...
      public function edit_renewaldraft($application_id)
    {
        ...
        return view('user_login.renew-form_ea', compact('application', 'proprietors', 'draftCount', 'staffs', 'document', 'license_details'));
    }
    ...
    public function renew_form_ea_old($appl_id){
        ...
        $staffs = DB::table('tnelb_applicant_formA_staffdetails')
        ->where('application_id', $appl_id)
        ->get();
