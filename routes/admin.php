...
// use App\Models\Admin;
    ...
    Route::prefix('admin')->name('admin.')->middleware('web')->group(function () {
        ...
        // FORM-A Specific
            ...
            Route::get('/view_forma_pending', [AuditorController::class, 'view_forma_pending'])->name('view_forma_pending');
            Route::get('/view_forma_completed', [AuditorController::class, 'view_forma_completed'])->name('view_forma_completed');
            Route::get('/view_sec_forma_pending', [SecretaryController::class, 'view_sec_forma_pending'])->name('view_sec_forma_pending');
            Route::get('/view_sec_forma_completed', [SecretaryController::class, 'view_sec_forma_completed'])->name('view_sec_forma_completed');
            Route::get('/president_pending_forma', [PresidentController::class, 'president_pending_forma'])->name('president_pending_forma');
