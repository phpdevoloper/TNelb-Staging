    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            ...
            <div class="collapse collapse-menu show" id="competencyMenu">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('apply-form-s')); ?>">
                            <i class="fa fa-arrow-circle-o-right"></i> Apply for License C [Form S]
                        </a>
                    </li>
        
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('apply-form-w')); ?>">
                            <i class="fa fa-arrow-circle-o-right"></i> Apply For License B [Form W]
                        </a>
                    </li>
        
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('apply-form-wh')); ?>">
        ...
        <li class="nav-item">
            ...
            <div class="collapse collapse-menu show" id="contractorMenu">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('apply-form-a')); ?>"><i class="fa fa-arrow-circle-o-right"></i>Apply For License EA [Form A]</a>
                    </li>
                </ul>
            </div>
        </li>
              ...
              <li class="nav-item">
         <a class="nav-link" href="<?php echo e(route('expiry_date_change')); ?>"><i class="fa fa-arrow-circle-o-right"></i>
...
<?php /**PATH D:\xampp\hddocs\TNelb-Staging\resources\views/include/sidebar.blade.php ENDPATH**/ ?>