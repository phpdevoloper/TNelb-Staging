          ...
          <div class="row text-center">
                <div class="col-lg-12  text-center">
                    ...
                    <div class="col-lg-12 col-md-8 col-12  ">
                        <?php $__currentLoopData = $footerbottom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footerbottommenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <?php
                                    $link = '#';
                                    $target = '';
                                    ...
                                    <?php if($footerbottommenu->page_type === 'pdf'): ?>
                                    <?php if($footerbottommenu->menuPage?->pdf_en): ?>
                                    <i class="fa fa-file "></i>
                                    <a href="<?php echo e(asset($footerbottommenu->menuPage->pdf_en)); ?>" target="_blank" title="English PDF">
                                        <i class="fa fa-file-pdf-o text-danger"></i> <?php echo e($label); ?> (EN)
                                    </a>
                                    <?php endif; ?>
                                    <?php if($footerbottommenu->menuPage?->pdf_ta): ?>
                                    <i class="fa fa-file "></i>
                                    <a href="<?php echo e(asset($footerbottommenu->menuPage->pdf_ta)); ?>" target="_blank" title="Tamil PDF">
                                        <i class="fa fa-file-pdf-o text-success"></i> <?php echo e($label); ?> (TA)
                                    </a>
                                    <?php endif; ?>
                                    <?php elseif($footerbottommenu->page_type === 'submenu'): ?>
                                    — <?php echo e($label); ?>
...
<script src="<?php echo e(url('assets/js/scriptnew.js')); ?>"></script>
...
<script src="<?php echo e(url('assets/js/jquery.fancybox.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/isotope.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/owl.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/appear.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/wow.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/lazyload.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/scrollbar.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/TweenMax.min.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/swiper.min.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/jquery.polyglot.language.switcher.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/jquery.ajaxchimp.min.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/parallax-scroll.js')); ?>"></script>
<script src="<?php echo e(url('assets/admin/src/plugins/src/flatpickr/flatpickr.js')); ?>"></script>


<script src="<?php echo e(url('assets/js/script.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/custom.js')); ?>"></script>

<script src="<?php echo e(url('assets/js/forma.js')); ?>"></script>
<!-- --------------------------------------------------------------- -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#refresh-captcha").click(function(e) {
            e.preventDefault();
            $("#image-captcha").attr("src", "<?php echo e(url('captcha/image')); ?>?" + Math.random());
        });
        ...
        $('#verify_btn').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('verifylicense')); ?>",
                method: "POST",
                data: {
...
// -----------form A --------------code ---------------
        ...
        function submitFormAFinalrenew(formData, actionType, applicationId) {
            ...
            let url = applicationId ?
                "<?php echo e(route('forma.update', ['appl_id' => '_APPL_ID'])); ?>".replace('_APPL_ID', applicationId) :
                "<?php echo e(route('forma.store')); ?>";
        ...
        function downloadPDFformArenew(language, loginId) {
        ...
        function submitFormAFinal(formData, actionType) {
            $.ajax({
                url: "<?php echo e(route('forma.store')); ?>",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
    ...
    function showDeclarationModal(form_name) {
        ...
        document.getElementById('ea_declarationProceedBtn').onclick = function() {
            ...
            let url = applicationId ?
                "<?php echo e(route('forma.update', ['appl_id' => '__APPL_ID__'])); ?>".replace('__APPL_ID__', applicationId) :
                "<?php echo e(route('forma.store')); ?>";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 200) {
                        const login_id = window.login_id || "<?php echo e(auth()->user()->login_id ?? ''); ?>";
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "<?php echo e(route('form.updatePayment')); ?>",
                                    type: "POST",
                                    data: {
                                        login_id: login_id,
    ...
    try {
        ...
        let response = await $.ajax({
            url: '<?php echo e(route('getFormCost')); ?>',
            method: 'GET',
        ...
        modalEl.querySelector('#proceedPayment').addEventListener('click', async function() {
            ...
            if (applicationId) {
                if (appl_type === 'R') {
                    formUrl = "<?php echo e(route('form.draft_renewal_submit', ['appl_id' => '__APPL_ID__'])); ?>"
                        .replace('__APPL_ID__', applicationId);
                } else {
                    formUrl = "<?php echo e(route('form.update', ['appl_id' => '__APPL_ID__'])); ?>"
                        .replace('__APPL_ID__', applicationId);
                }
            } else {
                formUrl = "<?php echo e(route('form.store')); ?>";
            }
    ...
    //         // let formUrl = applicationId ? "<?php echo e(url('formdraft-update')); ?>/" + applicationId : "<?php echo e(route('form.store')); ?>";


    //         let applicationId = $('#application_id').val();

    //         let formUrl = applicationId ? "<?php echo e(route('form.update', ['appl_id' => '__APPL_ID__'])); ?>".replace('__APPL_ID__', applicationId) : "<?php echo e(route('form.store')); ?>";
    ...
    function verifyCompetencyLicense() {
        ...
        $.ajax({
            url: "<?php echo e(route('verifylicenseformAcc')); ?>",
            method: 'POST',
            data: {
                license_number: licenseNumber,
                date: date,
    ...
    function verifyEALicense() {
        ...
        $.ajax({
            url: "<?php echo e(route('verifylicenseformAea')); ?>",
            method: 'POST',
            data: {
                license_number: licenseNumber,
                date: date,
...
<?php /**PATH D:\xampp\hddocs\TNelb-Staging\resources\views/include/footer.blade.php ENDPATH**/ ?>