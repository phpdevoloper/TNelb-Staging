                    ...
                    <div class="card1 register">
                        ...
                        <form id="login-form">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <img src="<?php echo e(captcha_src('flat')); ?>" alt="CAPTCHA" id="image-captcha">
                        ...
                        <p class="text-md-right register_title mt-3"> <a href="<?php echo e(route('register')); ?>" style="text-decoration: underline;"> Click to Register </a></p>
                    </div>
                </div>
            </div>
        </div>
...
<footer class="main-footer">
    ...
    <script>
        $(document).ready(function() {
            $("#login-form").submit(function(event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('login.check')); ?>", // Laravel route
                    data: {
         ...
         document.addEventListener("DOMContentLoaded", function() {
            ...
            $("#validateBtn").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('login.verify')); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        otp: otp
                    },
  ...
  <?php /**PATH D:\xampp\hddocs\TNelb-Staging\resources\views/login.blade.php ENDPATH**/ ?>